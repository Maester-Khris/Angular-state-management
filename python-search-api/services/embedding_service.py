...
class EmbeddingService:
    ...
    def _initialize_resources(self):
        ...
        if self.groq is None:
            print("Lazy Loading: Initializing Groq embedding client...")
    ...
    def _get_embedding(self, text: str) -> list[float]:
        """Vectorize text via Groq. Triggers lazy initialization."""
        self._initialize_resources()
        response = self.groq.embeddings.create(
    ...
    def search_similar_post(self, query_text: str, limit: int = 10) -> list:
        ...
        if self.client is None or self.groq is None:
            return []
